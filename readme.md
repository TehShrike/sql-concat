...
`expression` strings are inserted without being parameterized, but you can also pass in [tagged template strings](https://github.com/daytonlowell/sql-concat#tagged-template-strings) to do anything special.
